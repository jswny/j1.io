...
interface TerminalState { currentText: string; lines: Array<Line> }
    ...
    for (let i = 0; i < this.state.lines.length; i++) {
      ...
      lines.push(
        <div key={i} className="terminal-line">
          ...
          <TerminalInput autofocus={autofocus} text={this.state.lines[i].input} handleSubmitFunction={(input: string) => this.handleSubmitInput(input)} />
